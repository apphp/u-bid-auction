...
<?php if(!$fieldCount): ?>
	<div class="input-group">
		<input class="form-control" maxLength="128" placeholder="<?= A::t('news', 'Email Address');?>" id="news_subscribers_email" autocomplete="off" type="text" required value="" name="email" />
