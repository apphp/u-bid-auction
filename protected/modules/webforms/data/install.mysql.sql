...
(NULL, 'webforms', 'WebForms', 'Web Forms', 'Web Forms module allows creating online forms on site pages', '0.0.4', 'icon.png', 0, 0, 1, 0, 1, '<CURRENT_DATETIME>', NULL, 0, (SELECT COUNT(m.id) + 1 FROM `<DB_PREFIX>modules` m WHERE m.is_system = 0));
