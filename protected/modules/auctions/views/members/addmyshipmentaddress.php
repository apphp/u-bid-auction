<?php
$this->_pageTitle = A::t('auctions', 'Add Address');
...
<div class="col-sm-12">
    ...
    $fields['separatorAddress']['country_code'] = array('type' => 'select', 'title' => A::t('auctions', 'Country'), 'tooltip' => '', 'default' => $defaultCountryCode, 'validation' => array('required' => true, 'type' => 'set', 'source' => array_keys($countries)), 'data' => $countries, 'htmlOptions' => array('onchange' => $onchange, 'class' => 'form-control'));
    ...
    $fields['separatorOtherInfo']['is_default'] = array('type' => 'checkbox', 'title' => A::t('auctions', 'Default'), 'default' => '0', 'validation' => array('type' => 'set', 'source' => array(0, 1)));
    $fields['member_id'] = array('type' => 'data', 'default' => $memberId);

    echo CWidget::create('CDataForm', array(
        'model' => 'Modules\Auctions\Models\ShipmentAddress',
        'operationType' => 'add',
        'action' => 'members/addMyShipmentAddress/memberId/' . $memberId,
