<?php
$this->_pageTitle = A::t('auctions', 'Terms & Conditions');
$this->_breadCrumbs = array(
    array('label' => A::t('app', 'Home'), 'url'=>Website::getDefaultPage()),
    array('label'=> A::t('auctions', 'Member Login'), 'url'=>'members/login'),
    array('label' => A::t('auctions', 'Member Registration'), 'url'=>'members/registration'),
    array('label' => A::t('auctions', 'Terms & Conditions')),
);
?>

<div class="row">
    <p>Terms and conditions template for website usage</p>
    ...
    <p>Your use of this website and any dispute arising out of such use of the website is subject to the laws of [country].</p>
</div>