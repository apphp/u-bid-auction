...
$this->_breadCrumbs = array(
    ...
    array('label'=>A::t('auctions', 'Add Member')),
);

$formName = 'frmMembersAdd';
...
<div class="bloc">
    <?= $tabs; ?>
    <div class="sub-title"><?= A::t('auctions', 'Add Member'); ?></div>
    <div class="content">
    <?php
        echo CWidget::create('CDataForm', array(
            ...
            'fields'    => array(
               ...
               'separatorAddress' => array(
                   ...
                   'country_code'  => array('type'=>'select', 'title'=>A::t('auctions', 'Country'), 'tooltip'=>'', 'default'=>$defaultCountryCode, 'validation'=>array('required'=>$paramsFormRegistration['country_code']['required'], 'type'=>'set', 'source'=>array_keys($countries)), 'data'=>$countries, 'htmlOptions'=>array('onchange'=>$onchange)),
                ...
                'separatorAccount' => array(
                    ...
                    'email'             => array('type'=>'textbox', 'title'=>A::t('auctions', 'Email'), 'default'=>'', 'validation'=>array('required'=>$paramsFormRegistration['email']['required'], 'type'=>'email', 'maxLength'=>100, 'unique'=>true), 'htmlOptions'=>array('maxlength'=>100, 'autocomplete'=>'off', 'class'=>'middle')),
                    'username'          => array('type'=>'textbox', 'title'=>A::t('auctions', 'Username'), 'default'=>'', 'validation'=>array('required'=>true, 'type'=>'username', 'minLength'=>6, 'maxLength'=>32, 'unique'=>true), 'htmlOptions'=>array('maxlength'=>32, 'autocomplete'=>'off')),
                    'password'          => array('type'=>'password', 'title'=>A::t('auctions', 'Password'), 'default'=>'', 'validation'=>array('required'=>true, 'type'=>'password', 'minLength'=>6, 'maxLength'=>25), 'encryption'=>array('enabled'=>CConfig::get('password.encryption'), 'encryptAlgorithm'=>CConfig::get('password.encryptAlgorithm'), 'encryptSalt'=>$salt), 'htmlOptions'=>array('maxlength'=>25, 'placeholder'=>'&#9679;&#9679;&#9679;&#9679;&#9679;')),
                    'passwordRetype'    => array('type'=>'password', 'title'=>A::t('auctions', 'Confirm Password'), 'default'=>'', 'validation'=>array('required'=>true, 'type'=>'confirm', 'confirmField'=>'password', 'minLength'=>6, 'maxlength'=>25), 'htmlOptions'=>array('maxlength'=>25, 'placeholder'=>'&#9679;&#9679;&#9679;&#9679;&#9679;')),
                    'salt'              => array('type'=>'hidden', 'default'=>$salt),
