...
(NULL, 'tickets', '', 'email_on_user_reply', '1', 'Email on User Reply', 'Specifies whether to send email to admin when user replies to the ticket', 'bool', '', '', '', '', 0),
...
(NULL, 0, 'pagelink', 'tickets', 'tickets/userManageTickets', '', 'top', 6, 'public', 1);
...
(NULL, 1, 'member', 'Test', '2018-02-22 10:00', 'test1@example.com', 'Test 1', 0, 0),
(NULL, 2, 'member', 'Test', '2018-02-23 10:00', 'test2@example.com', 'Test 2', 0, 0);
...
INSERT INTO `<DB_PREFIX>email_templates` (`id`, `code`, `module_code`, `is_system`) VALUES (NULL, 'user_reply', 'tickets', 1);
INSERT INTO `<DB_PREFIX>email_template_translations` (`id`, `template_code`, `language_code`, `template_name`, `template_subject`, `template_content`)
SELECT NULL, 'user_reply', code, 'New reply on ticket by user', 'User replied to the ticket', 'Admin,\r\n\r\nUser left a new message in ticket #{TICKET_ID}\r\n-------------------\r\n\Name: {FULL_NAME}\r\nEmail: {EMAIL}\r\nDept: {DEPT}\r\n\r\n{CONTENT}\r\n-------------------\r\n\r\nTo view/respond to the ticket, please login to the support ticket system.' FROM `<DB_PREFIX>languages`;
