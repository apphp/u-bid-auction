    ...
    <div class="content">
	    ...
	    <div class="central-part" id="right-editpost">
			...
			<div class="buttons-wrapper">
				...
				<input value="<?= A::t('blog', 'Update'); ?>" type="submit">
			</div>
		</div>
	    ...
	    <div class="buttons-wrapper">
            <input type="submit" name="btnUpdateClose" value="<?= A::t('blog', 'Update & Close'); ?>">
			<input type="submit" name="btnUpdate" value="<?= A::t('blog', 'Update'); ?>">
			<input type="button" class="button white" onclick="$(location).attr('href','posts/manage<?= $additionalParams; ?>');" value="<?= A::t('blog', 'Cancel'); ?>">
		</div>
