...
class PostsController extends CController
{
    ...
    {
        Website::prepareBackendAction('manage', 'posts', 'posts/manage');
    ...
    {
        Website::prepareBackendAction('add', 'posts', 'posts/manage');
    ...
    {
        Website::prepareBackendAction('insert', 'posts', 'posts/manage');
    ...
    {
        Website::prepareBackendAction('edit', 'posts', 'posts/manage');
    ...
    {
        Website::prepareBackendAction('update', 'posts', 'posts/manage');
    ...
    {
        Website::prepareBackendAction('delete', 'posts', 'posts/manage');
