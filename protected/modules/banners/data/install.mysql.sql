...
(1, 'banner1.jpg', 'banner1_thumb.jpg', 'auctions/categories/4', 0, 1),
...
INSERT INTO `<DB_PREFIX>banners_translations` (`id`, `banner_id`, `language_code`, `banner_title`, `banner_text`, `banner_button`) SELECT NULL, 1, code, 'Smartphones', 'Only we have the most popular smartphones at the best prices!<br/>Take part in the auction, win and enjoy.', 'View Auctions' FROM `<DB_PREFIX>languages`;
INSERT INTO `<DB_PREFIX>banners_translations` (`id`, `banner_id`, `language_code`, `banner_title`, `banner_text`, `banner_button`) SELECT NULL, 2, code, '', '', '' FROM `<DB_PREFIX>languages`;
INSERT INTO `<DB_PREFIX>banners_translations` (`id`, `banner_id`, `language_code`, `banner_title`, `banner_text`, `banner_button`) SELECT NULL, 3, code, '', '', '' FROM `<DB_PREFIX>languages`;
