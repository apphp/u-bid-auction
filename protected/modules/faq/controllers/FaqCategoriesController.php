...
class FaqCategoriesController extends CController
{
    ...
    {        
        Website::prepareBackendAction('manage', 'faq', 'faqCategories/manage');
    ...
    {
        Website::prepareBackendAction('add', 'faq', 'faqCategories/manage');
    ...
    {         
        Website::prepareBackendAction('edit', 'faq', 'faqCategories/manage');
    ...
    public function changeStatusAction($id, $page = 1)
    {
        ...
        if ($changeResult) {
            ...
            $alert = A::t('faq', 'An error occurred while changing FAQ Category status!');
            $alertType = 'error';
        }
    ...
    {
        Website::prepareBackendAction('delete', 'faq', 'faqCategories/manage');
