...
class FaqCategoryItemsController extends CController
{
    ...
    {         
        Website::prepareBackendAction('manage', 'faq', 'faqCategoryItems/manage');
    ...
    {
        Website::prepareBackendAction('add', 'faq', 'faqCategoryItems/manage');
        $this->_checkCategoryAccess($catId);
    ...
    {
        Website::prepareBackendAction('edit', 'faq', 'faqCategoryItems/manage');
        $this->_checkCategoryAccess($catId);
    ...
    public function changeStatusAction($catId = 0, $id = 0, $page = 1)
    {
        ...
        if ($changeResult) {
            ...
            $alert = A::t('faq', 'An error occurred while changing FAQ Category Item status!');
            $alertType = 'error';
        }
    ...
    {
        Website::prepareBackendAction('delete', 'faq', 'faqCategoryItems/manage');
        $this->_checkCategoryAccess($catId);
