<?php
    ...
    $this->_activeMenu = 'faqCategoryItems/manage';
    $this->_breadCrumbs = array(
        ...
        array('label'=>A::t('faq', 'Add Category Item')),
    );
...
<div class="bloc">
    ...
    <div class="sub-title">
        ...
        <?= '» '.A::t('faq', 'Add Category Item'); ?>
    </div>

    <div class="content">
    <?php
        $formName = 'frmFaqCategoryItemAdd';
        echo CWidget::create('CDataForm', array(
            'model'         => '\Modules\Faq\Models\FaqCategoryItems',
            'operationType' => 'add',
            'action'        => 'faqCategoryItems/add/catId/'.$catId,
            ...
            'translationFields' => array(
                'faq_question' => array('type'=>'textarea', 'title'=>A::t('faq', 'Question'), 'validation'=>array('required'=>true, 'type'=>'text', 'maxLength'=>255), 'htmlOptions'=>array('maxLength'=>'512')),
                'faq_answer' => array('type'=>'textarea', 'title'=>A::t('faq', 'Answer'), 'validation'=>array('required'=>false, 'type'=>'any', 'maxLength'=>2048), 'htmlOptions'=>array('maxLength'=>'2048')),
            ),
            'buttons'=>array(
