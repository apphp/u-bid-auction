...
(20, 4, '<SITE_BO_URL>emailTemplates/', '', '', 1, 1, 1),
(21, 4, '<SITE_BO_URL>mailingLog/', '', '', 1, 1, 2),
(22, 5, '<SITE_BO_URL>currencies/', '', '', 1, 1, 1),
(23, 5, '<SITE_BO_URL>paymentProviders/', '', '', 1, 1, 2),
...
(18, 18, 'en', 'Languages'),
(19, 19, 'en', 'Vocabulary'),
(20, 20, 'en', 'Email Templates'),
(21, 21, 'en', 'Mailing Log'),
(22, 22, 'en', 'Currencies'),
(23, 23, 'en', 'Payment Providers'),
...
(4, 'paypal_standard', 'PayPal Standard', 'To make PayPal Standard payments processing system works on your site you have to perform the following steps:\r\n\r\n1. Create an account on PayPal: https://www.paypal.com\r\n\r\n2. After account is created, log into and select from the top menu: My Profile.\r\nOn My Profile page select from the My selling tools: Instant Payment Notification (IPN) Preferences.\r\nTurn ''On'' IPN by selecting Receive IPN messages (Enabled) and write into Notification URL:\r\n{site}/paymentProviders/handlePayment/paypal/{model}/{module_name}, where {site} is a full URL to your site, {module_name} is a name of the main module and {model} is a handler model.\r\nFor example:\r\nhttp://your-domain.com/paymentProviders/handlePayment/paypal/orders/shoppingcart or\r\nhttp://your-domain.com/site_directory/paymentProviders/handlePayment/paypal/orders/shoppingcart\r\n\r\n3. Then go to My Profile -> Website preferences, turn Auto Return ''On'' and write into Return URL: {site}/paymentProviders/successPayment,\r\nwhere {site} is a full URL to your site.\r\nFor example: http://your-domain.com/paymentProviders/successPayment', 'PayPal Payments Standard allows you to pay with credit cards, debit cards, PayPal, and PayPal Credit.', 'merchant_id', 'sales@example.com', '', '', 'global', 1, 3, 0, 1),
(5, 'paypal_recurring', 'PayPal Recurring', 'To make PayPal Recurring payments processing system works on your site you have to perform the following steps:\r\n\r\n1. Create an account on PayPal: https://www.paypal.com\r\n\r\n2. After account is created, log into and select from the top menu: My Profile.\r\nOn My Profile page select from the My selling tools: Instant Payment Notification (IPN) Preferences.\r\nTurn ''On'' IPN by selecting Receive IPN messages (Enabled) and write into Notification URL:\r\n{site}/paymentProviders/handlePayment/paypal/{model}/{module_name}, where {site} is a full URL to your site, {module_name} is a name of the main module and {model} is a handler model.\r\nFor example:\r\nhttp://your-domain.com/paymentProviders/handlePayment/paypal/orders/shoppingcart or\r\nhttp://your-domain.com/site_directory/paymentProviders/handlePayment/paypal/orders/shoppingcart\r\n\r\n3. Then go to My Profile -> Website preferences, turn Auto Return ''On'' and write into Return URL: {site}/paymentProviders/successPayment,\r\nwhere {site} is a full URL to your site.\r\nFor example: http://your-domain.com/paymentProviders/successPayment', 'PayPal Recurring Payments allows you to pay for subscription payments and installment plan payments.', 'merchant_id', 'sales@example.com', '', '', 'global', 1, 3, 0, 1);
