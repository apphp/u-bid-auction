...
$(document).ready(function(){
    ...
    $('#menucollapse').click(function(){
        ...
        let isCollapsed=body.hasClass('collapsed');
    ...
    // DEFINE EVENT ON scroll-up icon
    // --------------------------------------
    if($('.scrollup').length){
...
function hideElementsFromArray(cName, elFind){
    ...
    for(var i = 0; i < cookieArrName.length; i++){
        if(cookieArrName[i] != ''){
            ...
            // Toggle open/collapse icon
            $('#'+cookieArrName[i]).find('a.toggle').toggleClass('hide');
        }
    }
}
...
|--------------------------------------------------------------------------
*/
$.fn.forceNumericOnly = function(t){
...
|--------------------------------------------------------------------------
*/
$.fn.preventButtonDoubleSubmission = function() {
...
$.fn.preventLinkDoubleSubmission = function() {
    $(this).on('click',function(e){
        if($(this).data('submitted') === true){
            // Previously submitted - don't submit again
            e.preventDefault();
